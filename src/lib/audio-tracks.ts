...
export const TRACKS: Record<TrackKey, { url: string; label: string }> = {
  drift: {
    url: publicUrl("audio/BET-RAY Drift.mp3"),
    label: "BET-RAY Drift — tema do laboratório",
  },
  ledger: {
    url: publicUrl("audio/Quiet Ledger.mp3"),
    label: "Quiet Ledger — clima analítico",
  },
  fruit: {
    url: publicUrl("audio/Spinning Fruit Study.mp3"),
    label: "Spinning Fruit Study — giro dos símbolos",
  },
  steam: {
    url: publicUrl("audio/Steam Scale Loop.mp3"),
    label: "Steam Scale Loop — medida do café",
  },
  pebble: {
    url: publicUrl("audio/Measured Pebble Loop.mp3"),
