...
export const SYMBOL_KEYS: SymbolKey[] = ["pera", "maca", "ovo", "xicara", "pao", "cafe"];
...
function Sym({ children, label }: { children: ReactNode; label: string }) {
  return (
    <svg viewBox="0 0 64 64" className="h-14 w-14 drop-shadow" role="img" aria-label={label}>
      {children}
    </svg>
  );
}
...
export function Pera() {
  return (
    <Sym label="Pera">
      <path d="M30 8 q3 4 5 8" stroke="#5a3a16" strokeWidth="2" fill="none" strokeLinecap="round" />
      <path d="M35 10 q5 -3 9 -1 q-2 4 -8 4" fill="#7fb069" />
      <path
        d="M32 18 c-9 0 -14 8 -14 18 c0 12 8 20 14 20 c6 0 14 -8 14 -20 c0 -10 -5 -18 -14 -18z"
        fill="#c8d96f"
        stroke="#6b8e1f"
        strokeWidth="1.5"
      />
      <ellipse cx="27" cy="32" rx="3" ry="6" fill="#fff" opacity="0.45" />
    </Sym>
  );
}
  ...
  return (
    <Sym label="Maçã">
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <ellipse cx="24" cy="32" rx="4" ry="7" fill="#fff" opacity="0.4" />
    </Sym>
  );
}
...
export function Ovo() {
  return (
    <Sym label="Ovo">
      <path
        d="M32 8 c-10 0 -18 14 -18 28 c0 12 8 20 18 20 c10 0 18 -8 18 -20 c0 -14 -8 -28 -18 -28z"
        fill="#fff8e7"
        stroke="#c9a85c"
        strokeWidth="1.5"
      />
      <ellipse cx="26" cy="26" rx="4" ry="8" fill="#fff" opacity="0.7" />
      <circle cx="42" cy="40" r="2" fill="#e6cfa0" opacity="0.6" />
    </Sym>
  );
}
  ...
  return (
    <Sym label="Xícara">
      ...
      <path
        ...
        strokeWidth="1.6"
      />
      <path d="M22 26 h20 v14 c0 4 -4 8 -10 8 c-6 0 -10 -4 -10 -8z" fill="#6b3a16" opacity="0.85" />
      <path d="M46 26 q8 1 8 8 q0 7 -8 8" fill="none" stroke="#36506b" strokeWidth="1.6" />
      <ellipse cx="28" cy="30" rx="4" ry="1.5" fill="#fff" opacity="0.5" />
    </Sym>
  );
}
...
export function Pao() {
  return (
    <Sym label="Pão">
      <path
        d="M10 30 q6 -16 22 -16 q16 0 22 16 q2 4 -2 6 q-20 6 -40 0 q-4 -2 -2 -6z"
        fill="#d49a5a"
        stroke="#7a4a18"
        strokeWidth="1.6"
      />
